with decls.dgenerals, decls.dtdesc, Ada.Sequential_Io, Ada.Text_Io, 
	 decls.d_taula_de_noms, semantica.ctipus; 
use decls.dgenerals, decls.dtdesc, decls.d_taula_de_noms, semantica.ctipus;
